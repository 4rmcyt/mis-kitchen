...
import { PctBar } from "../components/PctBar.js";
import { Modal } from "../components/Modal.js";
import type { ShiftReport } from "../../lib/types.js";

interface ReportRow extends ShiftReport {
  name: string;
  pct: number;
  done: number;
  total: number;
            ...
            <tbody>
              {filtered.map(r => (
                <tr key={r.id} className="row-clickable" onClick={() => setSelected(r)}>
                  ...
                  <td><Badge color={STATION_COLORS[r.profiles?.station || '']||'#6B7280'} small>{r.profiles?.station || '—'}</Badge></td>
                  <td>
          ...
          <div className="report-modal-body">
            <div className="report-modal-hdr">
              ...
              <div>
                ...
                <div className="report-modal-sub">{selected.profiles?.station || '—'} · {selected.date}</div>
              </div>
